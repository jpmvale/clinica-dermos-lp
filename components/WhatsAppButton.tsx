...
export default function WhatsAppButton() {
  return (
    ...
    >
      <span className="hidden group-hover:flex items-center bg-dark text-white text-xs font-display tracking-widest uppercase px-4 py-2 rounded-full shadow-lg whitespace-nowrap transition-all duration-300">
        Agendar Consulta
      </span>
      <motion.div
